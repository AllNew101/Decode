...
//        }
        ...
        tracking = Turret.targeting(lead.getPose().getX(), lead.getPose().getY(), is_red, follower.getPose().getHeading() / Math.PI * 180,offset);
        adj = Ying.distance_adjustment(lead.getPose().getX(), lead.getPose().getY(), is_red);
        ...
        if (check_B) {Ying.run_shooter(adj + target, manual);}//Ying.run_shooter(target);
    ...
    public void debug(){
        ...
        switch (key){
            ...
            case 4:
                ...
                telemetryX.addData("t",dynamics.get_t(),2);
                telemetryX.addData("a",dynamics.get_a(),2);
                telemetryX.addData("b",dynamics.get_b(),2);
                telemetryX.addData("c",dynamics.get_c(),2);
                telemetryX.addData("vb",dynamics.get_vb(),2);
                telemetryX.addData("dis",dynamics.get_dis(),2);
                telemetryX.addData("dot",dynamics.get_dot(follower.getVelocity()),2);
                break;
            case 5:
