...
public class Autonomous_solo_red extends OpMode {
    ...
    private final Pose Pre_keep3 = new Pose(43.000, -100.000, Math.toRadians(-90));
    private final Pose keep3 = new Pose(43.000, -128.000, Math.toRadians(-900));
    ...
    ///////////////////////////////////////////////////////////////////////////////////
    public final Pose Final = new Pose(74.000, -110.00, Math.toRadians(-90));
    //Bazier zone
        ...
        switch (pathState) {
            ...
            case 20:
                if (!follower.isBusy()){
                    ...
                    closer.close();
                    follower.setMaxPower(0.8);
                    follower.followPath(go_prekeep3);
                    setPathState(2020);
                    break;}
            case 2020:
                if (!follower.isBusy()){
