...
public class Autonomous_BlueNEAR extends OpMode {
    ...
    private final Pose scorePose3 = new Pose(-50, -34, Math.toRadians(42));
    private final Pose P_keep3 = new Pose(-88, -30, Math.toRadians(88));
    private final Pose keep3 = new Pose(-88, -8, Math.toRadians(88));
    private final Pose scorePose4 = new Pose(-50, -36, Math.toRadians(40));
        ...
        switch (pathState) {
            ...
            case 1:
                if (!follower.isBusy()){
                    ...
                    shooter1.setPower(0.54);
                    shooter2.setPower(0.54);
                    setPathState(2);
                    break;
                }
