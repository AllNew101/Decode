...
@Autonomous(name = "Blue Mid")
public class Autonomous_BlueMID extends OpMode {
    ...
    private final Pose scorePose = new Pose(68, 4, Math.toRadians(40)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose P_keep1 = new Pose(68, 5, Math.toRadians(90));
    private final Pose keep1 = new Pose(65, 20, Math.toRadians(90));
    private final Pose open_keep1 = new Pose(57, 30, Math.toRadians(90));
    private final Pose scorePose2 = new Pose(68, 4, Math.toRadians(40));
    private final Pose P_keep2 = new Pose(40.8, 5, Math.toRadians(90));
    private final Pose keep2 = new Pose(40.8, 30, Math.toRadians(91));
    private final Pose scorePose3 = new Pose(64, 3.5, Math.toRadians(41));
    private final Pose P_keep3 = new Pose(18, 5, Math.toRadians(90));
    private final Pose keep3 = new Pose(18, 30, Math.toRadians(90));
    private final Pose scorePose4 = new Pose(68, 4, Math.toRadians(41.6));
...
//                    center_motor.setPower(0);
            ...
            case 4:
                if (!follower.isBusy()){
                    ...
                    shooter1.setPower(0.534);
                    shooter2.setPower(0.534);
//                        center_motor.setPower(0);
                    setPathState(5);
                    break;
                }
